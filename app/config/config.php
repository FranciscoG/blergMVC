...
/**
 * Defining custom log locations
 */
$cfg['logs']['error'] = ROOT . DS . APP_DIR . DS . 'tmp' . DS . 'error.log';
$cfg['logs']['debug'] = ROOT . DS . APP_DIR . DS . 'tmp' . DS . 'debug.log';
define('DEBUG_LOG', $cfg['logs']['debug']);
...
/************************************************************* 
* PHP ini override settings - Please refer \apache\bin\php.ini
*************************************************************/
/**
 * Location of the local runtime error log
 */
$cfg['php']['error_log'] = $cfg['logs']['error'];
